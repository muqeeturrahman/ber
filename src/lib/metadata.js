...
export const pageMetadata = {
  ...
  jobs: {
    ...
    description: 'Browse our curated job listings and find exciting career opportunities with top companies. Search and filter jobs by location, type, and experience level.',
