  ...
  return (
    <section className="section-padding bg-black">
      <div className="container-custom">
            ...
            return (
              ...
              >
                <div className="card h-full p-8 hover:shadow-2xl transition-all duration-300">
                  {/* Icon */}
                  <div className="w-16 h-16 bg-yellow-400/20 rounded-xl flex items-center justify-center mb-6 group-hover:bg-yellow-400/30 transition-colors duration-300">
                    <IconComponent className="w-8 h-8 text-yellow-400" />
                  </div>

                  {/* Title */}
                  <h3 className="text-xl font-bold text-gray-100 mb-4 group-hover:text-yellow-400 transition-colors duration-300">
                    {service.title}
                  </h3>
        ...
        >
          <div className="bg-gray-900 rounded-2xl p-8 md:p-12 shadow-lg border border-yellow-900/30">
